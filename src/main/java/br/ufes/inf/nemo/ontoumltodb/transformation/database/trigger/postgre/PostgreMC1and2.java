...
public class PostgreMC1and2 {
	private TraceTable traceTable;
	
	public PostgreMC1and2(TraceTable traceTable) {
	...
	private String getRestriction(MissingConstraintData constraint, Node currentNode) {
		...
		text.append("then \n");
		text.append(tab2);
		text.append("RAISE EXCEPTION 'ERROR 1: Violating conceptual model rules[XX_TRIGGER_NAME_XX].'; \n"); 
		text.append(tab1);
		text.append("end if; \n\n");
	...
	private String getInverseRestriction(MissingConstraintData constraint, Node currentNode) {
		...
		text.append("then \n");
		text.append(tab3);
		text.append("RAISE EXCEPTION  'ERROR 2: Violating conceptual model rules[XX_TRIGGER_NAME_XX].'; \n"); 
		text.append(tab2);
		text.append("end if; \n\n");
		text.append(tab1);
		text.append("end if; \n\n");
